...
* [Collate](https://docs.getcollate.io/api-reference/data-contracts/odcs#import-from-odcs) - Managed OpenMetadata cloud service for unified metadata management and semantic intelligence, with enterprise support.
...
* [OpenMetadata](https://docs.open-metadata.org/latest/api-reference/data-contracts/odcs#import-from-odcs) - Open and unified metadata platform for data discovery, observability, and governance
