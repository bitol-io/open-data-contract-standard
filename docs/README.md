...
The Open Data Contract Standard (ODCS) is a community-driven specification for data contracts that enables data sharing between organizations in a trusted and standardized way.
